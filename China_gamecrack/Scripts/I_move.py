...
def BuyTickets(ws, num, remove_pos):
    ...
    cl.nomal_press_keyboard("esc", slp=0.5)
    time.sleep(3)
    cl.nomal_press_keyboard("numpad_6", slp=3)
    time.sleep(1)
    cl.click(475,285)
    time.sleep(0.2)
    cl.click(475, 285)
    cl.two_key_together("numpad_6", "numpad_8", slp=3)
    time.sleep(1)
    cl.nomal_press_keyboard("numpad_8", slp=0.5)
    time.sleep(1)
    cl.nomal_press_keyboard("spacebar", slp=0.5)
    time.sleep(3)
    cl.nomal_press_keyboard("numpad_6", slp=5)
    time.sleep(1)
    cl.click(580, 341)
    time.sleep(1)
    cl.click(630, 391)
...
def stepintomap(ws):
    ...
    cl = ControlWindow.windowcl()
    cl.move_window(ws._handle, 0, 0)
    cl.nomal_press_keyboard("numpad_2", slp=1)
    cl.nomal_press_keyboard("numpad_6", slp=4)
